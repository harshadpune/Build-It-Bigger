...
import com.udacity.javajoketeller.JokeTeller;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void tellJoke(View view) {
        ...
        Intent showJokeIntent = new Intent(this, DisplayJokeActivity.class);
        showJokeIntent.putExtra(AppConstants.INTENT_JOKE_INFO, ""+jokeTeller.getJoke());
